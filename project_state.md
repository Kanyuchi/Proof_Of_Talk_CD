...
**Last updated:** 2026-05-16 (evening) — **Rhuna granular pass names now preserved.** `extasy_sync.py` was collapsing 7 Rhuna passes (General / Startup / Press / Investor / VIP / VIP Black / Speaker / Sponsor) into the 4-value `TicketType` enum. Granular name now lives at `enriched_profile.extasy.ticket_name` (nested JSONB, no migration). All 362 existing Rhuna attendees backfilled; writers updated in extasy_sync, the Runa webhook, and the standalone ingest script. New "Ticket Types (Rhuna)" card on the Dashboard renders the live breakdown from the matchmaker's own DB. Distribution at backfill: 244 General · 46 VIP · 30 Press · 16 VIP Black · 14 Investor · 10 Startup · 1 Media.
